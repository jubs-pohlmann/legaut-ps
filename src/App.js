...
function App() {
  ...
  function selectText(e) {
    ...
    if( selectedText.baseNode &&
        selectedText.baseNode.parentElement.id === 'documentText' &&
  ...
  function highlight(selection){
    ...
    let newText = documentText.substring(0, selection.docStart) + `<span class="${marker}Marker">` + documentText.substring(selection.docStart, selection.docEnd) + "</span>" + documentText.substring(selection.docEnd, documentText.length);
    setDocumentText(newText);
    document.getElementById('documentText').innerHTML = documentText;
    console.log(document.getElementById('documentText'));
  }
